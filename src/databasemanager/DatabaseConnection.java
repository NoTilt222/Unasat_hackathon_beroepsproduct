...
public class DatabaseConnection {
    private static final String URL = "jdbc:mysql://localhost:3306/unasat";  // Declare a private static final variable named URL that contains the URL to connect to the database.
    ...
    private static final String PASSWORD = "P2palfa#040402@1";  // Declare a private static final variable named PASSWORD that contains the password to connect to the database.
